...
import { Image, StyleSheet, View, Text, SafeAreaView, Pressable, Dimensions,Link,
  Platform, Appearance } from 'react-native';
import { SearchBar } from 'react-native-elements';
import {Colors} from '@/constants/Colors'
import Background from '@/assets/images/background.jpg'
import { TextInput } from 'react-native-gesture-handler';
import { useNavigation } from '@react-navigation/native';  // Za navigaciju
...
export default function HomeScreen() {
  ...
  const navigation = useNavigation() //inicijalizovanje navigacije
     ...
     {/* <SearchBar
      ...
      /> */}
        ...
        <View style = {styles.imageContainer}>
          <Image source ={require('@/assets/images/list.jpg')}
          style = {{width : width,
           height : height * 0.6,
           marginTop : 10}} resizeMode = 'contain '/>
        </View>
        <Link href = ''
          <Pressable
